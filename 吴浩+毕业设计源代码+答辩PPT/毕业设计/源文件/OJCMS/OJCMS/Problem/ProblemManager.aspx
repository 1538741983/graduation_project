<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemManager.aspx.cs" Inherits="OJCMS.Problem.ProblmeManager" %>
                            ...
                            <f:Grid ID="Grid1" runat="server" BoxFlex="1" PageSize="20" ShowBorder="True" ShowHeader="false" IsDatabasePaging="true"
                                ...
                                <Columns>
                                    ...
                                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                                        WindowID="Window1" Title="编辑问题信息" HeaderText="编辑" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/Problem/ProblemInfo.aspx?action=Edit&id={0}"
                                        Width="50px" />
                                    <f:WindowField ColumnID="viewField" TextAlign="Center" Icon="Zoom" ToolTip="查看"
                                        WindowID="Window1" Title="查看问题信息" HeaderText="查看" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/Problem/ProblemInfo.aspx?action=View&id={0}"
                                        Width="50px" />
