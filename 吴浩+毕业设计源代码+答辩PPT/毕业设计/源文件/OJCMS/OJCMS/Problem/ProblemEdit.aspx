<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemEdit.aspx.cs" ValidateRequest="false" Inherits="OJCMS.Problem.ProblemEdit" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form LabelWidth="70px" LabelAlign="Right" runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="10px"
            ...
            <Items>
                <f:GroupPanel runat="server" Layout="Table" ColumnWidth="25% 25% 25% 25%" TableConfigColumns="4" Title="基本信息">
                    <Items>
                ...
                <f:Panel ID="Panel1" Layout="Column" ShowHeader="false" ShowBorder="false" runat="server">
                    <Items>
                        ...
                        <f:ContentPanel Title="123" ID="ContentPanel3" ColumnWidth="100%" Height="200px" runat="server" ShowBorder="false" ShowHeader="false">
