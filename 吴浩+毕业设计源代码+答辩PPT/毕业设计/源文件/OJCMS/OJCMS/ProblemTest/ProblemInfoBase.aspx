<%@  Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemInfoBase.aspx.cs" Inherits="OJCMS.ProblemTest.ProblemInfoBase" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form LabelWidth="70px" LabelAlign="Right" runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="10px"
            ...
            <Items>
                <f:GroupPanel ID="GroupPanel1" runat="server" Layout="Table" ColumnWidth="50% 50%" TableConfigColumns="2" Title="基本信息">
                    <Items>
