<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleInfo.aspx.cs" Inherits="OJCMS.Role.RoleInfo" %>
        ...
        <f:Form runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="10px"
            ...
            <Rows>
                <f:FormRow runat="server" ID="FormRow2">
                    <Items>
                        <f:TextBox runat="server" LabelAlign="Right" ID="TxtName" LabelWidth="70px" Label="用户名" Required="True" ShowRedStar="True"></f:TextBox>
...
<%--                <f:FormRow runat="server" ID="FormRow1">
                ...
                <f:FormRow ID="FormRow3" runat="server">
                    <Items>
                        <f:HiddenField ID="RoleId" runat="server"></f:HiddenField>
                        <f:HiddenField runat="server" ID="Action"/>
                    </Items>
                </f:FormRow>
            </Rows>
        </f:Form>
