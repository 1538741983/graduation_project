<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleManager.aspx.cs" Inherits="OJCMS.Role.RoleManager" %>
                    ...
                    <f:Region ID="Region2" runat="server" BodyPadding="5px"
                        ...
                        <Items>
                            <f:Grid ID="Grid1" runat="server" BoxFlex="1" PageSize="20" ShowBorder="True" ShowHeader="false" IsDatabasePaging="true"
                                ...
                                <Columns>
                                    <f:BoundField DataField="Id" Width="150px" Hidden="true" HeaderText="角色ID" />
                                    <f:BoundField DataField="Name" SortField="用户名" Width="100px" HeaderText="角色名称" />
                                    ...
                                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                                        WindowID="Window1" Title="编辑角色信息" HeaderText="编辑" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/Role/RoleInfo.aspx?action=Edit&id={0}"
                                        Width="50px" />
