...
namespace JudgeEngine
{
    ...
    public static class JudgeProcessFactory
    {
        /// <summary>
        /// 生产编译进程
        /// </summary>
        ...
        public static ICompilerProcess GetCompilerProcess(string language)
        {
            CompilerInfo compilerInfo = GetCompilerInfo(language);
            ICompilerProcess compilerProcess = new CompilerProcess(compilerInfo.Path, compilerInfo.ArgumentsFormat);
        ...
        internal static IRunProcess GetRunProcess()
        {
            IRunProcess runProcess = new RunProcess();
