...
namespace JudgeEngine.Process
{
    ...
    public class BaseProcess : System.Diagnostics.Process, IBaseProcess
    {
        ...
        {
            get { return outputStringInfo.ToString(); }
        }
        ...
        public new bool Start()
        {
            ...
            outputStringInfo.Append(StandardOutput.ReadToEnd());
            errorStringInfo.Append(StandardError.ReadToEnd());
