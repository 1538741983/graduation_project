<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemInfo.aspx.cs" Inherits="OJCMS.Problem.ProblemInfo" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form LabelWidth="70px" LabelAlign="Right" runat="server" ShowBorder="false" ShowHeader="false" BodyPadding="10px"
            Title="SimpleForm" ID="SimpleForm1" AutoScroll="True" HideMode="Visibility">
            <Toolbars>
                <f:Toolbar runat="server" ID="Toolbar1" Hidden="True" ToolbarAlign="Right" Position="Bottom">
                    <Items>
            ...
            <Items>
                ...
                <f:GroupPanel runat="server" Layout="Table" ColumnWidth="25% 25% 25% 25%" TableConfigColumns="4" Title="基本信息" ID="BasicInfo">
                    <Items>
                        <f:Label runat="server" Hidden="True" ID="ProblemId" />
                ...
                <f:Panel ID="Panel1" Layout="Column" ShowHeader="false" ShowBorder="false" runat="server">
                    <Items>
                        ...
                        <f:ContentPanel ID="ContentPanel3" ColumnWidth="100%" Height="300px" runat="server" ShowBorder="false" ShowHeader="false">
