<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManager.aspx.cs" Inherits="OJCMS.User.UserManager" %>
                    ...
                    <f:Region ID="Region2" runat="server" BodyPadding="5px"
                        ...
                        <Items>
                            <f:Grid ID="Grid1" runat="server" BoxFlex="1" PageSize="20" ShowBorder="True" ShowHeader="false" IsDatabasePaging="true"
                                ...
                                <Toolbars>
                                    <f:Toolbar ID="Toolbar1" runat="server">
                                        <Items>
                                            ...
                                            <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="请输入用户名"
                                ...
                                <Columns>
                                    <f:BoundField DataField="Id" Width="150px" Hidden="true" HeaderText="用户ID" />
                                    <f:BoundField DataField="Username" SortField="用户名" Width="100px" HeaderText="用户名" />
                                    <f:BoundField DataField="Password" SortField="用户密码" Width="100px" HeaderText="用户密码" />
                                    ...
                                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                                        WindowID="Window1" Title="编辑用户信息" HeaderText="编辑" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/User/UserEdit.aspx?id={0}"
                                        Width="50px" />
                                    <f:WindowField ColumnID="viewField" TextAlign="Center" Icon="Zoom" ToolTip="查看"
                                        WindowID="Window1" Title="查看用户信息" HeaderText="查看" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/User/UserView.aspx?id={0}"
                                        Width="50px" />
